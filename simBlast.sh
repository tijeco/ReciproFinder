...
cd $working_dir
python ../makeseed.py
/media/BigRAID/JeffTemp/EvolvAGene4Package/EvolveAGene4-linux-x86-64 -f seed.fa -n $1 -o Phy -b 0.32
...
do
	cd $f
	/media/BigRAID/JeffTemp/EvolvAGene4Package/EvolveAGene4-linux-x86-64 -f $f.fa -n $1 -o Phy -b 0.32
	cd ..
